  ...
  return (
    <footer>
        ...
        <div className="row">
          <div className="col-lg-4 col-md-6">
            ...
            <ul className="list-unstyled three-column">
              ...
              <li>
                <a href="https://www.linkedin.com/in/devhamza/" target="_blank">
                  Linkedin
                </a>
              </li>
              <li>
            ...
            <ul className="list-unstyled socila-list"></ul>
          </div>

          <div className="col-lg-4 col-md-6">
            <h3>Favourite quotes</h3>
            <div className="media">
              <a href="#" className="pull-left"></a>
      ...
      <div className="copyright text-center">
        Designed & Developed By Hamza | Made with <span>React.JS</span> | Hosted
